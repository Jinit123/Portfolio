            ...
            <div className='row justify-content-center'>
                <div className='col-sm-12 col-md-10 col-lg-6'>
                    <div className="container p-5" ref={containerRef}>
                        ...
                        <p className='text-center text-white'>I am a MERN Stack Developer, passionate about building fast, scalable, and user-friendly web applications using MongoDB, Express.js, React, and Node.js. My expertise lies in crafting seamless backend systems that integrate effortlessly with dynamic frontend experiences, ensuring optimal performance and a smooth user journey. With a strong foundation in modern web technologies, I focus on creating solutions that are efficient, reliable, and tailored to meet diverse user needs.<br /><br />
                        ...
                        <div className='d-flex justify-content-center'>
                            <a className="btn btn-outline-primary text-white mt-3 px-4 py-2" href='/Jinit_Mewada_Resume.pdf' download>Download Resume</a>
                        </div>
                    </div>
                </div>
            </div>
